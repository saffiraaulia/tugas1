...
function renderAyat(surahData) {
  const versesHTML = surahData.verses
    .map(
      (verse, index) => `
      <div class="space-y-3 bg-green-50 p-5 rounded-xl shadow-sm border border-green-100">
        <div class="flex justify-between items-center">
          <span class="uppercase tracking-widest font-semibold text-xs text-green-600">
        ...
        <p class="text-green-950 text-sm leading-relaxed">
